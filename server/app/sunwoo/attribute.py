...
TABLE_RULES = (
    " 근거의 표에는 여러 회계연도 열이 나란히 있다. 예를 들어 제5기·제4기·제3기가 한 표에 함께 나온다."
    " 각 근거 머리글의 '기준연도'가 그 보고서의 당기이고, 표의 첫 번째 수치 열이 그 당기 값이다."
    " 이전 기(제4기·제3기) 열의 값을 당기 값으로 쓰지 마라."
    " 어느 연도 열을 읽었는지 답변에 함께 밝혀라."
)
